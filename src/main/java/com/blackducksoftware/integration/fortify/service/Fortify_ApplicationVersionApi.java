...
@Configuration
public class Fortify_ApplicationVersionApi {
    @Autowired
    ...
    private Fortify_ApplicationVersionApiService apiService;
    ...
    private void init() {
        ...
        apiService = retrofit.create(Fortify_ApplicationVersionApiService.class);
    }
